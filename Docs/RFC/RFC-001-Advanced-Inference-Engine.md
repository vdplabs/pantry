...
| **Phase 2** | **Structured Output & Grammars** | JSON schema & regex logit maskers, `response_format` enforcement, tool-call guard | ⏳ Planned |
| **Phase 3** | **Semantic Reranking** | `/v1/rerank` endpoint, cross-encoder runtime, `pantry rank` CLI, RAG evaluation | ⏳ Planned |
